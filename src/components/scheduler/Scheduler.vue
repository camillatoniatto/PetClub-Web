            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="8" md="6">
                    <v-select
                      @click="listaPetUser(schedulers.idClient)"
  ...
  methods: {
    ...
    salvar(schedulerSelecionado) {
      ...
      if (schedulerSelecionado.idScheduler == "") {
        register
          .postScheduler(schedulerSelecionado)
          .then(() => {
            schedulerSelecionado = {};
            this.errors = {};
        ...
        register
          .putScheduler(schedulerSelecionado)
          .then((response) => {
            console.log("aaaa", schedulerSelecionado);
            (this.schedulerSelecionado = {}), (this.errors = {});
